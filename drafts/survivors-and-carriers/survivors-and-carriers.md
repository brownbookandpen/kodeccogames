...
![Patient Zero card, before and after the Survivor/Carrier relabel](Images/patient-zero.png "Patient Zero — old Custodians banner on the left, new Survivor banner with the role name kept below in the subtitle area.")

![Apprentice card, before and after the Survivor/Carrier relabel](Images/apprentice.png "Apprentice — same simplification, Secret Role up top, role name below")

![Curefinder card, before and after the Survivor/Carrier relabel](Images/curefinder.png "Curefinder — the mission text stays the same, only the Secret Role banner changes")

![Carrier-side Executioner card, before and after the relabel](Images/executioner.png "Renamed to Executioner (To emphasize he kills), the Carrier Secret Role, now labeled the same simple way")

![Carrier-side Saboteur card, before and after the relabel](Images/saboteur.png "Saboteur — the main cause of failed encounters. Unlike the Executioner, who can both kill and sabotage, the Saboteur cannot kill.")
