...
![Character Roster](Images/img-1.png "At this point, we had 5 Characters per class, and 8 classes, that meant we had 40 unique Characters.")
...
![The Tracer](Images/img-2.png "The Tracer is one of the earliest developed Characters, back when she was called 'Codebreaker'")
...
![The Pickpocket](Images/img-3.png "On deployment, and after 2 rounds, we knew the simple mechanic of Pickpocket was extremely overpowered in a game like this.")
...
![The Brawler](Images/img-4.png "The 'Hunter Class' one of our favourite additions to the game.")
...
![The Watcher](Images/img-5.png "The latest, and most recent addition to the game, The Scrapper Classes. ")
...
![The Amnesiacs](Images/img-6.png)
...
![The Class Indicator](Images/img-8.png)
...
![The Character Art](Images/img-9.png)
...
![The Participant Indicator](Images/img-7.png)
